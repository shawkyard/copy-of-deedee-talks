        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, fontSize: "clamp(2.5rem, 6vw, 4.5rem)", color: "#ffffff", lineHeight: 1.1, marginBottom: "1.25rem" }}>
              She Is the <span style={{ color: "#C084A8", fontStyle: "italic" }}>Conversation.</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="relative" style={{ minHeight: 500 }}>
              <div
                ...
                style={{
                  ...
                  boxShadow: "0 0 60px rgba(192,132,168,0.20), 0 20px 60px rgba(0,0,0,0.70)",
                }}
              >
                <img
                ...
                />
                <div className="absolute inset-0" style={{ background: "linear-gradient(to top, rgba(26,15,46,0.88) 0%, transparent 55%)" }} />
            ...
            <div>
              ...
              <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.8rem, 3.5vw, 2.6rem)", color: "#1A0F2E", lineHeight: 1.2, marginBottom: "1.5rem" }}>
                A Woman of Faith, Grit, and <span style={{ color: "#C084A8", fontStyle: "italic" }}>Unapologetic Voice</span>
              </h2>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1rem", color: "rgba(26,15,46,0.70)", lineHeight: 1.8, marginBottom: "1.25rem" }}>
              ...
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1rem", color: "rgba(26,15,46,0.70)", lineHeight: 1.8, marginBottom: "2rem" }}>
                Whether she is co-hosting <em style={{ color: "#C084A8" }}>By Grit and Grace</em> with her friend Heather, stepping onto a stage, or sitting across from someone who just needs to be heard, Denise brings the same thing every time: faith-filled courage, genuine warmth, and the kind of honesty that makes you feel less alone.
              </p>
              <blockquote style={{ borderLeft: "3px solid #C084A8", paddingLeft: "1.25rem", marginBottom: "2rem", fontFamily: "'Playfair Display', serif", fontStyle: "italic", fontSize: "1.05rem", color: "rgba(26,15,46,0.80)" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: "#ffffff" }}>
              The Beliefs Behind <span style={{ color: "#C084A8", fontStyle: "italic" }}>Every Word</span>
            </h2>
          </div>
      ...
      <section style={{ background: "#1A0F2E", padding: "6rem 0" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: "#ffffff", marginBottom: "1.5rem" }}>
            From a Podcast to a <span style={{ color: "#C084A8", fontStyle: "italic" }}>Movement</span>
          </h2>
          <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.8, marginBottom: "1.25rem" }}>
            DD Talks grew from a genuine desire to connect, encourage, and speak truth. What started as a podcast — <em style={{ color: "#C084A8" }}>By Grit and Grace – We Are Warriors</em>, co-hosted with her friend Heather — has become the foundation of a broader personal brand platform that is just getting started.
          </p>
