  ...
  return (
    <div style={{ background: "#1E2E20", minHeight: "100vh" }}>
      ...
      <section className="relative overflow-hidden" style={{ paddingTop: "clamp(72px, 8vw, 80px)", minHeight: "clamp(260px, 40vh, 55vh)", display: "flex", alignItems: "center" }}>
        ...
        <div className="absolute inset-0" style={{ background: "rgba(30, 46, 32,0.80)" }} />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, fontSize: "clamp(2.2rem, 5vw, 4rem)", color: "#ffffff", lineHeight: 1.1, marginBottom: "1rem" }}>
              By Grit &amp; Grace —{" "}
              <span style={{ color: "#7BA7BC", fontStyle: "italic" }}>We Are Warriors</span>
            </h1>
      ...
      {/* Stats */}
      <section style={{ background: "#F5F0E8", padding: "3rem 0" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="dd-glass-light p-5 text-center">
                <p style={{ fontFamily: "'Playfair Display', serif", fontWeight: 700, fontSize: "2rem", color: "#7BA7BC" }}>{s.value}</p>
                <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.75rem", color: "rgba(30, 46, 32,0.50)", letterSpacing: "0.1em", textTransform: "uppercase" }}>{s.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Category filter */}
      <section style={{ background: "#1E2E20", padding: "3rem 0 0" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {CATEGORIES.map((cat) => (
              <button
                ...
                style={{
                  ...
                  padding: "0.4rem 1rem",
                  borderRadius: "4px",
                  border: `1px solid ${activeCategory === cat ? "#7BA7BC" : "rgba(123, 167, 188,0.20)"}`,
                  background: activeCategory === cat ? "rgba(123, 167, 188,0.12)" : "transparent",
                  color: activeCategory === cat ? "#7BA7BC" : "rgba(255,255,255,0.55)",
                  cursor: "pointer",
      ...
      {/* Episode list */}
      <section style={{ background: "#1E2E20", padding: "2rem 0 6rem" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {filtered.map((ep, i) => (
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  {ep.featured && (
                    <span className="dd-badge" style={{ background: "rgba(123, 167, 188,0.20)", color: "#7BA7BC" }}>Featured</span>
                  )}
                </div>
          ...
          {filtered.length === 0 && (
            <div className="text-center py-16">
              <Mic size={40} style={{ color: "rgba(123, 167, 188,0.30)", margin: "0 auto 1rem" }} />
