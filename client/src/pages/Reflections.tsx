...
export default function Reflections() {
  return (
    <div style={{ background: "#1E2E20", minHeight: "100vh" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontWeight: 800, fontSize: "clamp(2.2rem, 5vw, 4rem)", color: "#ffffff", lineHeight: 1.1, marginBottom: "1rem" }}>
              Thoughts Worth <span style={{ color: "#7BA7BC", fontStyle: "italic" }}>Sitting With</span>
            </h1>
      ...
      {/* Reflections grid */}
      <section style={{ background: "#1E2E20", padding: "4rem 0 6rem" }}>
            ...
            {REFLECTIONS.map((r, i) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.72rem", color: "#7BA7BC", fontWeight: 600 }}>Read More →</span>
                </div>
              </motion.div>
            ))}
          </div>
